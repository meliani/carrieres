...
class InternshipsPerCountryChart implements ChartFactory
{
    ...
    public function chart(): Chart
    {
        ...
        $internships = \App\Models\School\Internship\Internship::selectRaw('count(*) as count, internships.pays')
