            ...
            <div class="card-panel">
                <div class="row center">
                    ...
                    <h1 class="light center blue-text text-lighten-1">
                        {{App\Models\Profile\Professor::find($internship->meta_pedagogic_validation['signatures']['professor_id'])->name}}
                    </h1>
                    <h1 class="light center blue-text text-lighten-1">
                        date de validation : {{\Carbon\Carbon::parse($internship->meta_pedagogic_validation['dates']['created_at'])->format('d M Y')}}
                    </h1>
                </div>
            </div>
        </div>
