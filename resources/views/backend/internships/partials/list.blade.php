            ...
            @foreach ($internships as $internship)
                <tr>
                    @if (isset($internship->student))
                        ...
                        <td>
                            <div class="waves-effect sub strong">{{ $internship->student->full_name }}
                            </div>
                            @isset($internship->binome)
                                <span class="new badge orange lighten-3 white-text tooltipped" data-delay="50"
                        ...
                        <td class="center">
                            @if (isset($internship->adviser->adviser1))
                                ...
                                <a class="center"
                                    href={{ route('Project.create', ['pin' => $internship['id'], 'advisor' => '1']) }}><i
                                        class="tiny material-icons">edit</i></a>
                            @else
                                <a href={{ route('Project.create', ['pin' => $internship['id'], 'advisor' => '1']) }}><i
                        ...
                        <td class="center">
                            @if (isset($internship->adviser->adviser2))
                                ...
                                <a class="center"
                                    href={{ route('Project.create', ['pin' => $internship['id'], 'advisor' => '2']) }}>
