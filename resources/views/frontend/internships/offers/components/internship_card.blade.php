        ...
        <ul class="collapsible">
            ...
            <li>
                <div class="collapsible-header"><i
                    ...
                    str_limit($offer->project_title, 50) !!}
                </div>
                <div class="collapsible-body">
            ...
            <li>
                <div class="collapsible-header"><i
                        class="small material-icons blue-grey-text textlighten-5">queue</i>Détails et Prérequis
                </div>
                <div class="collapsible-body">
            ...
            <li>
                ...
                {{-- <div class="collapsible-body">
                    <p>{!!
                        Html::link(asset('storage/uploads/internships/offers/submited_files/'.$offer->document_offre),"Voir
                        le
                        document") !!}</p>
                </div> --}}
                {{-- <div class="collapsible-body">
                ...
                <div class="collapsible-body">
                    <p>{!! Html::link(
                        Storage::disk('interOffersDocs')->url($offer->attached_file),
            ...
            @endif
            @if ($offer->responsible_email && $offer->applyable == 0)
            <li>
                <div class="collapsible-header"><i
                        class="small material-icons blue-grey-text textlighten-5">local_offer</i><b>Contact direct</b>
                </div>
                <div class="collapsible-body">
