...
color:Black;
font-weight:normal;
border:solid Black 1.0pt;padding:1.0pt 5.5pt 5.5pt 1.0pt;
}
.tm65 {
margin:1.0pt;
margin-top:1.0pt;
...
<p class="tm34 tm82 tm86"><strong><span class="tm87"></span></strong><span class="tm89">La pr&eacute;sente convention r&egrave;gle les rapports de&nbsp;: </span><strong><span
 class="tm90">{{ $internship->raison_sociale }}</span><span class="tm91">-</span><span class="tm90">{{ $internship->adresse }}</span><span
 class="tm91">-</span><span class="tm90">{{ $internship->ville }}</span><span class="tm91">,</span><span class="tm90">{{ $internship->pays }}</span><span
...
<p class="tm34 tm82 tm86"><strong><span class="tm87"></span></strong><span class="tm89">Concernant le stage de Fin d&#8217;&eacute;tudes de</span><strong><span
 ...
 class="tm90">{{ $internship->person->filiere_text }}</span></strong><span class="tm89">, 
        de l’Institut National des Postes et Télécommunications (INPT) de Rabat, 
        en échange académique à l’Ecole . . . . . . . . . . . . . . . . . . . . . sur l’année scolaire  . . . . . . . . . . . . .  dans le cadre d’un partenariat,     
</span></p>
...
demand&eacute;s explicitement par le programme, participer &agrave; des r&eacute;unions; Le cas &eacute;ch&eacute;ant, les dates seront port&eacute;es &agrave; la connaissance de l&#39;Entreprise par l&#39;Etablissement.</span></em></p>
<p class="tm71 tm82 tm93"><em><span class="tm101"></span><span class="tm112">Le r&egrave;glement de l&#8217;INPT pr&eacute;voit l&#39;encadrement du stagiaire au cours de sa p&eacute;riode de stage en entreprise. Cet encadrement
doit &ecirc;tre assur&eacute; par un enseignant de l&#8217;INPT et par un membre de l&#39;entreprise charg&eacute; d&#39;accueillir et d&#39;accompagner le stagiaire.</span></em></p>
<p class="tm76 tm82 tm86"><strong><span class="tm87"></span><span class="tm111">Art.3-</span></strong><span class="tm112"> Durant son stage, l&#39;&eacute;tudiant stagiaire est soumis &agrave; la discipline et au r&egrave;glement
int&eacute;rieur de l&#39;Entreprise, notamment en ce qui concerne les horaires, </span><strong><span class="tm111">la r&eacute;glementation du travail, les r&egrave;gles d&#8217;hygi&egrave;ne et de s&eacute;curit&eacute;
en vigueur dans l&#8217;entreprise</span></strong><span class="tm112">.</span></p>
<p class="tm78 tm82 tm86"><strong><span class="tm87"></span></strong><span class="tm112">Toute sanction disciplinaire ne peut &ecirc;tre d&eacute;cid&eacute;e que par l&#39;Institut. Dans ce cas, l&#8217;entreprise informe
l&#39;Institut des manquements et lui fournit &eacute;ventuellement les &eacute;l&eacute;ments constitutifs. L&#8217;entreprise, en accord avec le Directeur de l&#39;INPT, peut mettre fin au stage du stagiaire, tout en respectant
les dispositions fix&eacute;es &agrave; l&#8217;article 4 ci-apr&egrave;s.</span></p>
<p class="tm76 tm82 tm86"><strong><span class="tm87"></span><span class="tm111">Art.4-</span></strong><span class="tm112"> Toute absence devra &ecirc;tre signal&eacute;e par l&#8217;Entreprise &agrave; l&#8217;&eacute;tablissement.</span></p>
<p class="tm75 tm82 tm93"><span class="tm94"></span><span class="tm112">Dans le cas d&#8217;une interruption, d&#8217;une semaine au moins, pour motif circonstanci&eacute; ou contexte exceptionnel, autoris&eacute;e par l&#8217;entreprise,
un avenant &agrave; la pr&eacute;sente convention devra &ecirc;tre sign&eacute; au pr&eacute;alable par les cocontractants.</span></p>
<p class="tm75 tm82 tm93"><span class="tm94"></span><span class="tm112">En cas de volont&eacute; d&#8217;une des trois parties (entreprise, INPT, &eacute;tudiant(e)) d&#8217;interrompre d&eacute;finitivement le stage, </span><strong><span
 class="tm111">celle-ci devra imm&eacute;diatement en informer les deux autres parties par &eacute;crit. Les raisons invoqu&eacute;es seront examin&eacute;es en &eacute;troite concertation.</span></strong><span
 class="tm112"> La d&eacute;cision d&eacute;finitive d&#8217;interruption du stage ne sera prise qu&#8217;&agrave; l&#8217;issue de cette phase de concertation.</span></p>
<p class="tm71 tm82 tm93"><span class="tm94"></span><strong><span class="tm111">Art.5-</span></strong><span class="tm112"> Le stagiaire est couvert par l&#39;assurance de l&#8217;INPT contre les accidents pouvant survenir
au cours du stage dans la limite de garantie de son assurance.</span></p>
<p class="tm78 tm82 tm86"><strong><span class="tm87"></span><span class="tm111">Art.6-</span></strong><span class="tm112"> A l&#8217;issue du stage, l&#8217;&eacute;tudiant est tenu de pr&eacute;senter les r&eacute;sultats
de son travail, tant par &eacute;crit dans son m&eacute;moire de fin d&#8217;&eacute;tudes, qu&#39;oralement lors de sa soutenance devant un jury comprenant des repr&eacute;sentants de l&#8217;entreprise accueillante et des
enseignants de l&#8217;INPT. La pr&eacute;sentation et le rapport devront avoir &eacute;t&eacute; valid&eacute;s par l&#8217;entreprise au pr&eacute;alable et par l&#8217;enseignant encadrant &agrave; l&#8217;INPT. L&#39;&eacute;tudiant
s&#39;engage &agrave; fournir un rapport &agrave; l&#39;organisme d&#8217;accueil et &agrave; l&#39;INPT au maximum une semaine avant la date de la soutenance.</span></p>
<p class="tm79 tm82 tm93"><em><span class="tm101"></span><span class="tm112">A la fin du stage et avant la soutenance, le Directeur de stage mentionn&eacute; dans la convention est pri&eacute; de communiquer &agrave; l&#8217;&eacute;cole
une &eacute;valuation du comportement du stagiaire et de la qualit&eacute; du travail effectu&eacute;.</span></em></p>
<p class="tm78 tm82 tm86"><strong><span class="tm87"></span><span class="tm111">Art.7-</span></strong><span class="tm112"> Les &eacute;tudiants stagiaires prennent l&#39;engagement de n&#39;utiliser en aucun cas les informations
recueillies ou obtenues par eux pour en faire l&#39;objet de publication, communication &agrave; des tiers sans accord pr&eacute;alable de la Direction de l&#39;Entreprise, y compris le rapport de stage. Cet engagement vaudra
non seulement pour la dur&eacute;e du stage mais &eacute;galement apr&egrave;s son expiration. L&#39;&eacute;tudiant s&#39;engage &agrave; ne conserver, emporter, ou prendre copie d&#39;aucun document ou logiciel, de quelque
nature que ce soit, appartenant &agrave; l&#39;Entreprise, sauf accord de cette derni&egrave;re. L&#8217;Entreprise peut demander une restriction de la diffusion du rapport, voire le retrait de certains &eacute;l&eacute;ments
tr&egrave;s confidentiels. Les personnes amen&eacute;es &agrave; en conna&icirc;tre sont contraintes par le secret professionnel &agrave; n&#8217;utiliser ni ne divulguer les informations du rapport.</span></p>
<p class="tm80 tm82"><strong><span class="tm113"></span><span class="tm111">Art.8- </span></strong><span class="tm112">S&#8217;il advenait qu&#8217;un contrat de travail prenant effet avant la date de fin du stage soit sign&eacute;
avec l&#8217;Entreprise, la pr&eacute;sente convention deviendrait caduque&nbsp;; l&#8217;&eacute;tudiant stagiaire perdrait son statut d&#8217;&eacute;tudiant et ne rel&egrave;verait plus de la responsabilit&eacute; de l&#8217;Ecole.
