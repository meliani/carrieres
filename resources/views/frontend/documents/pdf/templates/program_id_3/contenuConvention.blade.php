...
<body>
    ...
    <p class="tm34 tm82 tm86"><strong><span class="tm87"></span></strong><span class="tm89">Concernant le stage de
            ...
            de la fili&egrave;re : </span><strong><span class="tm90">
    ...
    <p class="tm44 tm82">
        <span class="tm96">- </span><span class="tm89">Coordonnateur de la fili&egrave;re&nbsp;:
        </span><strong><span class="tm90">
    ...
    <p class="tm49 tm82 tm93"><span class="tm94"></span><span class="tm89">Descriptif d&eacute;taill&eacute;&nbsp;:
        </span><strong><span class="tm90">{{ $internship->description }}</span></strong><span
            class="tm89">&nbsp;</span></p>
    <p class="tm49 tm82 tm93"><span class="tm94"></span><span class="tm89">Adresse du
            stage&nbsp;</span><strong><em><span class="tm98">(adresse pr&eacute;cise, si diff&eacute;rente de
                    ...
                    ci dessus) : </span></em><span class="tm90">{{ $internship->office_location ?? '' }}
            </span></strong>
    ...
    <p class="tm51 tm82 tm86">
        <strong><span class="tm87"></span>
            <u><span class="tm88">ARTICLE SECOND&nbsp;:</span></u></strong>
    </p>
    ...
    <p class="tm71 tm82 tm93"><span class="tm94"></span><strong><span class="tm111">Art.1-</span></strong><span
            ...
            de PFE obligatoire
            pour l&#8217;obtention du dipl&ocirc;me d&#8217;Ingénieur en Télécommunications et Technologies de
            l'Information. L&#8217;objectif poursuivi du stage de PFE est de donner &agrave; chaque &eacute;tudiant
