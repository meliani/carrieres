    ...
    <ul class="collection">
        ...
        <li class="collection-item">
            <ul class="collapsible">
                <li>
                    <div class="collapsible-header"><i class="material-icons">person</i>{{ $person->long_full_name }}</div>
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons">business_center</i><b>Organisation:
                        </b>{{ $person->internship->organization_name }}</div>
                    <div class="collapsible-body">
                        <span>{{ $person->internship->city }} / {{ $person->internship->country }}</span>
                    </div>
                </li>
                <li>
