    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="center">
          ...
          <a class="btn-floating btn-small waves-effect waves-light blue @if ($pfe->nbr_advisors>=2) disabled @endif" href={{ route('pfeEncadrements.create', ['pin' => $pfe->id]) }}><i class="material-icons">group_add</i></a>
        </td>
        @endcan
      </tr>
      @endforeach
