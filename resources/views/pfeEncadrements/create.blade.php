                        ...
                        @if ($NbAdvisors > 0)
                            <ul class="collection">
                                <li class="collection-header">
                                    <h4>Liste des encadrants existants</h4>
                                </li>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="row">
                                    ...
                                    {!! Form::open([
                                        'action' => ['pfeEncadrementsController@store', 'pin' => $encadrements[0]->id],
                                        'method' => 'post',
                                        'files' => false,
                                    ]) !!}
                                    <div class="input-field col s12">
                                        <i class="material-icons prefix">supervisor_account</i>
                                        {{ Form::select('profs_advisor[]', $profs, null, ['multiple', 'id' => 'profs']) }}
